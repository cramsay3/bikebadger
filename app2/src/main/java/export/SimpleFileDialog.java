...
public class SimpleFileDialog
{
    ...
    public String Default_File_Name = "bikebadger.gpx";
    private String Selected_File_Name = Default_File_Name;
    private EditText input_text;
    public boolean SaveIt = false;
        ...
        try
        {
            ...
            for (File file : dirFile.listFiles())
            {
                ...
                else if (Select_type == FileSave || Select_type == FileOpen)
                {
                    ...
                    if(FileUtils.getExtension(sFilename).equals(".gpx") || FileUtils.getExtension(sFilename).equals(".GPX")) {
                                                             ...
                                                             DialogInterface.OnClickListener onClickListener)
    {
        ...
        if (Select_type == FileOpen    ) m_titleView1.setText("Open GPX File:");
