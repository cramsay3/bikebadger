...
public class RunListFragment extends ListFragment implements LoaderCallbacks<Cursor> {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        // the id argument will be the Ride ID; CursorAdapter gives us this for free
        Intent i = new Intent(getActivity(), RideActivity.class);
        i.putExtra(RideActivity.EXTRA_RUN_ID, id);
        startActivity(i);
    }
    ...
    private static class RunListCursorLoader extends SQLiteCursorLoader {
        ...
        protected Cursor loadCursor() {
            ...
            return RideManager.get(getContext()).queryRuns();
        }
    ...
    private static class RunCursorAdapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            // get the ride for the current row
            Ride ride = mRunCursor.getRun();
            
            // set up the start date text view
            TextView startDateTextView = (TextView)view;
            startDateTextView.setText("Ride at " + ride.getStartDate());
        }
