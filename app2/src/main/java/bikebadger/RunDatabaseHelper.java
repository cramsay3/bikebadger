...
public class RunDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "runs2.sqlite";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table location (" +
                ...
                " provider varchar(100), speed real, bearing real, run_id integer references run(_id))");
    }
    ...
    public long insertRun(Ride ride) {
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_RUN_START_DATE, ride.getStartDate().getTime());
    ...
    public long insertLocation(long runId, Location location) {
        ...
        cv.put(COLUMN_BEARING, location.getBearing());
     ...
     * The {@link getRun()} method will give you a Ride instance representing the current row.
     */
    public static class RunCursor extends CursorWrapper {
        ...
        /**
         * Returns a Ride object configured for the current row, or null if the current row is invalid.
         */
        public Ride getRun() {
            if (isBeforeFirst() || isAfterLast())
                return null;
            Ride ride = new Ride();
            ride.SetId(getLong(getColumnIndex(COLUMN_RUN_ID)));
            ride.setStartDate(new Date(getLong(getColumnIndex(COLUMN_RUN_START_DATE))));
            return ride;
        }
    }
    ...
    public static class LocationCursor extends CursorWrapper {
        ...
        public Location getLocation() {
            ...
            loc.setBearing(getFloat(getColumnIndex(COLUMN_BEARING)));
            loc.setSpeed(getFloat(getColumnIndex(COLUMN_SPEED)));
