...
package util.vending.licensing;
...
import util.vending.licensing.util.Base64;
import util.vending.licensing.util.Base64DecoderException;
...
public class LicenseChecker implements ServiceConnection {
    ...
    private util.vending.licensing.ILicensingService mService;
